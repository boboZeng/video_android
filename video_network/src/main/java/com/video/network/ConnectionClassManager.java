...
public class ConnectionClassManager {
    ...
    public synchronized double getDownloadKBytePerSecond() {
        return mDownloadBandwidth == null
                ? -1.0
                : mDownloadBandwidth.getAverage() / 8;
    }

    /**
     * Interface for listening to when {@link com.video.network.ConnectionClassManager}
     * changes state.
     */
    public interface ConnectionClassStateChangeListener {
        /**
         * The method that will be called when {@link com.video.network.ConnectionClassManager}
