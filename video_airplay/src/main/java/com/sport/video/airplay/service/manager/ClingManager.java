...
import com.sport.video.airplay.entity.ClingControlPoint;
import com.sport.video.airplay.entity.ClingDevice;
import com.sport.video.airplay.entity.IControlPoint;
import com.sport.video.airplay.entity.IDevice;
import com.sport.video.airplay.service.ClingUpnpService;
import com.sport.video.airplay.util.ListUtils;
...
//    private SystemService mSystemService;
    ...
    public Collection<ClingDevice> getDmrDevices() {
        System.out.println("ClingManager getDmrDevices mUpnpService:" + mUpnpService);
        if (Utils.isNull(mUpnpService)) {
            return null;
        }

        Collection<Device> devices = mUpnpService.getRegistry().getDevices(DMR_DEVICE_TYPE);
        System.out.println("ClingManager getDmrDevices devices:" + devices);
