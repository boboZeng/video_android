...
import com.sport.video.airplay.entity.ClingPositionResponse;
import com.sport.video.airplay.entity.ClingResponse;
import com.sport.video.airplay.entity.ClingVolumeResponse;
...
public class ClingPlayControl implements IPlayControl {
    ...
    private void setAVTransportURI(String url, final ControlCallback callback) {
        ...
        Utils.d("ClingPlayControl setAVTransportURI url:"+url);
        Utils.d("ClingPlayControl setAVTransportURI metadata:"+metadata);
        ...
        controlPointImpl.execute(new SetAVTransportURI(avtService, url, metadata) {
            ...
            public void success(ActionInvocation invocation) {
                super.success(invocation);
                Utils.d("ClingPlayControl setAVTransportURI success:");
                if (Utils.isNotNull(callback)) {
                    callback.success(new ClingResponse(invocation));
                }
            }
            ...
            @Override
            public void failure(ActionInvocation invocation, UpnpResponse operation, String defaultMsg) {
                Utils.d("ClingPlayControl setAVTransportURI failure:");
                if (Utils.isNotNull(callback)) {
                    callback.fail(new ClingResponse(invocation, operation, defaultMsg));
                }
            }
