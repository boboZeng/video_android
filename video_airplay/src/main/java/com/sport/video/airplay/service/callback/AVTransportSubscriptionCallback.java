package com.sport.video.airplay.service.callback;
...
import com.sport.video.airplay.service.DLNAAVTransportLastChangeParser;
...
//            LastChange lastChange = new LastChange(new AVTransportLastChangeParser(), lastChangeValue);
            LastChange lastChange = new LastChange(new DLNAAVTransportLastChangeParser(), lastChangeValue);
